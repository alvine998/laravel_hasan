...
class CreateTbSerahterimasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_serahterimas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tb_serahterimas');
    }
}
